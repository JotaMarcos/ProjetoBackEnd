package com.masterbare.projetobackendprimeiroexemplo.view.controller;
...
import com.masterbare.projetobackendprimeiroexemplo.view.model.*;
...
public class ProdutoController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProdutoResponse> atualizar(@RequestBody ProdutoRequest produtoReq, @PathVariable long id) {
        ModelMapper mapper = new ModelMapper();
        ProdutoDTO produtoDto = mapper.map(produtoReq, ProdutoDTO.class);
